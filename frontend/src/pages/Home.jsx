        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 pb-16 pt-14 md:grid-cols-2 md:pt-20">
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <a href="/gallery" className="inline-flex items-center justify-center rounded-md bg-sky-600 px-5 py-2 text-sm font-medium text-white shadow hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500">
                Explore Gallery
              </a>
            </div>
          </div>
